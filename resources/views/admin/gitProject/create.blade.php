        ...
        <table class="table table-striped table-bordered table-hover">
            <tr>
                ...
                <td>
                    ...
                    <input class="qjz-icheck" type="radio" name="type" value="1" @if(empty(old('type')) || old('type') == 1) checked @endif>
                    <span class="inputword">gitee</span>
                    <input class="qjz-icheck" type="radio" name="type" value="2" @if(old('type') == 2) checked @endif>
                </td>
            </tr>
            <tr>
                <th>项目</th>
