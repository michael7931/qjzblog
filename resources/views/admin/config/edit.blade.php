        ...
        <table class="table table-striped table-bordered table-hover">
            <tr>
                ...
                <td>
                    ...
                    <input class="qjz-icheck" type="radio" name="WEB_STATUS" value="1" @if($config['WEB_STATUS'] ==1) checked @endif>
                    <span class="inputword">关闭</span>
                    <input class="qjz-icheck" type="radio" name="WEB_STATUS" value="0" @if($config['WEB_STATUS'] ==0) checked @endif>
                </td>
            </tr>
            <tr>
                <th>网站关闭时提示文字：</th>
